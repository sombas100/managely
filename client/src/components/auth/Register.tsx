    ...
    <div className="relative h-screen">
      <form onSubmit={handleSubmit} className="w-2/3 h-full  mx-auto">
        <div className="block items-center justify-center bg-white w-[500px] mx-auto h-[550px] translate-y-52">
          ...
          />
          <input
            className="flex items-center mt-5 translate-y-32 w-full justify-center border hover:border-green-400 transition-all ease-in rounded-md bg-sky-100 p-2 mx-auto"
            type="text"
            placeholder="Email"
            value={email}
          ...
          <span className="flex translate-y-40 w-full text-sm">
            Already have a Managely account?{" "}
            <span
